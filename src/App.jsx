...
export default function App() {
  ...
  const handleSaveImage = async () => {
    ...
    if (captureRef.current) {
      try {
        ...
        // Adjust style for better capture quality
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 min-h-screen bg-gray-100 font-inter">
      ...
      {/* This is the hidden element for image generation */}
      <div ref={captureRef} className="absolute left-[-9999px] top-[-9999px] p-6 bg-white rounded-3xl" style={{ width: '210mm', height: '297mm', boxSizing: 'border-box', fontFamily: 'Inter, sans-serif' }}>
        <div className="w-full flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-gray-800">物件評価レポート</h2>
          <div className="flex items-center space-x-2">
            <span className="text-sm font-semibold text-gray-600">総合ランク:</span>
            <span className={`px-3 py-1 text-lg font-extrabold text-white rounded-full ${overallRank === 'N/A' ? 'bg-gray-400' : rankColors[overallRank]}`}>
              {overallRank}
            </span>
          </div>
        </div>
        
        {/* The image container for the report. object-contain keeps aspect ratio */}
        <div className="w-full h-[350px] flex flex-wrap gap-2 mb-4 overflow-hidden">
          {images.map((img, index) => (
            <div key={index} className="w-[calc(50%-4px)] h-[calc(50%-4px)] flex justify-center items-center overflow-hidden rounded-xl bg-gray-200">
              <img src={img} alt={`物件画像 ${index + 1}`} className="max-w-full max-h-full object-contain" />
            </div>
          ))}
        </div>
        
        {/* The section for property details and their ranks */}
        <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
          {/* Address row */}
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl col-span-2">
            <span className="text-gray-700">住所:</span>
            <span className="text-gray-900 font-medium">{address || '-'}</span>
          </div>
          
          {/* Other details with their respective ranks */}
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              {nearestStation || '-'}
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.stationIncome]}`}>
          ...
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              ...
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.walkToStation]}`}>
          ...
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              {interior || '-'}
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.interior]}`}>
                {itemRanks.interior}
              </span>
            </span>
          </div>
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            <span className="text-gray-700">看板設置可否:</span>
            <span className="text-gray-900 font-medium flex items-center">
              {signage || '-'}
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.signage]}`}>
                {itemRanks.signage}
              </span>
            </span>
          </div>
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              ...
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.rent]}`}>
                {itemRanks.rent}
              </span>
            </span>
          </div>
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              ...
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.initialCost]}`}>
          ...
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              {location || '-'}
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.location]}`}>
                {itemRanks.location}
              </span>
            </span>
          </div>
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              {floor || '-'}
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.floor]}`}>
                {itemRanks.floor}
              </span>
            </span>
          </div>
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              {visibility || '-'}
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.visibility]}`}>
                {itemRanks.visibility}
              </span>
            </span>
          </div>
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            <span className="text-gray-700">周辺世帯年収:</span>
            <span className="text-gray-900 font-medium flex items-center">
          ...
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              ...
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.household1km]}`}>
          ...
          <div className="flex items-center justify-between p-2 bg-gray-100 rounded-xl">
            ...
            <span className="text-gray-900 font-medium flex items-center">
              ...
              <span className={`ml-2 px-2 py-1 text-white font-bold rounded-full text-xs ${rankColors[itemRanks.household1_5km]}`}>
